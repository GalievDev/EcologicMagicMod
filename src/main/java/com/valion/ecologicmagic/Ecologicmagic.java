package com.valion.ecologicmagic;
...
import com.valion.ecologicmagic.world.gen.BiomeGen;
...
public class Ecologicmagic {
    ...
    public Ecologicmagic() {
        ...
        if(ModList.get().isLoaded("curios"))eventBus.addListener(IntegrationHandler::loadCurio);
    }
